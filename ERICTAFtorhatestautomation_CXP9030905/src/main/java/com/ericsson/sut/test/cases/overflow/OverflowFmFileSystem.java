 ...
 */
public class OverflowFmFileSystem extends HighAvailabilityTestCase {

    private static final Logger logger = LogManager.getLogger(OverflowFmFileSystem.class);
    ...
    public static Object[][] getData() {
        ...
        for (final Host host : RegressionUtils.getAllSvcHostList()) {
            ...
            final List<Object[]> cmList = vmHandler.addVmsForAFunctionalArea(virtualMachines, FunctionalArea.FM);
            list.addAll(cmList);
        }
    ...
    @Test(groups = {"High Availability"}, dataProvider = "getData", dataProviderClass = OverflowFmFileSystem.class)
