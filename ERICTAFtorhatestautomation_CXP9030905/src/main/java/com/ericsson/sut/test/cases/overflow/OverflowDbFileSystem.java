 ...
 */
public class OverflowDbFileSystem extends HighAvailabilityTestCase {

    private static final Logger logger = LogManager.getLogger(OverflowDbFileSystem.class);
    ...
    public static Object[][] getData() {
        ...
        for (final Host host : RegressionUtils.getAllSvcHostList()) {
            ...
            final List<Object[]> cmList = vmHandler.addVmsForAFunctionalArea(virtualMachines, FunctionalArea.DB);
            list.addAll(cmList);
    ...
    @Test(groups = {"High Availability"}, dataProvider = "getData", dataProviderClass = OverflowDbFileSystem.class)
