 ...
 */
public class OverflowPmFileSystem extends HighAvailabilityTestCase {

    private static final Logger logger = LogManager.getLogger(OverflowPmFileSystem.class);
    ...
    public static Object[][] getData() {
        ...
        for (final Host host : RegressionUtils.getAllSvcHostList()) {
            ...
            final List<Object[]> cmList = vmHandler.addVmsForAFunctionalArea(virtualMachines, FunctionalArea.PM);
            list.addAll(cmList);
        }
    ...
    @Test(groups = {"High Availability"}, dataProvider = "getData", dataProviderClass = OverflowPmFileSystem.class)
